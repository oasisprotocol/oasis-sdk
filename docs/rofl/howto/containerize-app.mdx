...
alternatives such as [Podman][podman] that mimic the same behavior.
...
accessible OCI registry where your image will be downloaded from for execution.
...
## Pin Your Image Hash for Extra Security
