...
- Preserved during ROFL upgrades.
...
In the example below, we make the `.ollama` home folder persistent to avoid
downloading ollama models each time a machine hosting the ROFL app is restarted:
