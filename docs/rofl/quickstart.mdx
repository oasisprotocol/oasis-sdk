...
[Containerize your app]: ./howto/containerize-app.mdx
...
You'll need about 150 tokens for ROFL registration, renting a machine and paying
for gas.

Create an account with [`oasis wallet create`] command. To get free Testnet
tokens, head over to the [Oasis faucet]. When deploying your app on Mainnet,
you will need to [buy ROSE][get-rose].
...
Based on your task, follow the How-to that fits your
needs most:
