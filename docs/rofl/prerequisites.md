---
description: How to build your first ROFL application
---

# Prerequisites

This chapter will show you how to install the software required for developing
a ROFL application using the Oasis SDK. After successfully completing all the
described steps you will be able to start building your first ROFL app!
...
While ROFL application development and testing can be performed on any machine
that has the appropriate tools, for actually running the applications, at least
one machine with appropriate TEE-enabled hardware is required.
...
<!-- markdownlint-disable line-length -->
[Set up Trusted Execution Environment (TEE)]: https://docs.oasis.io/node/run-your-node/prerequisites/set-up-trusted-execution-environment-tee
<!-- markdownlint-enable line-length -->
