...
pub async fn start_mock(cfg: Config<'_>) -> Result<(), rocket::Error>
{
    ...
    let env: Arc<dyn state::Env> = Arc::new(MockEnv::new(AppId::default(), Arc::new(signer)));
