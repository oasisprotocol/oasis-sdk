...
use crate::{
    ...
    precompile::{self, erc20::AccountToken},
...
impl AccountToken for TestErcToken {
    ...
    const GAS_COSTS: precompile::erc20::TokenOperationCosts =
        precompile::erc20::TokenOperationCosts::new();
...
fn test_erc20_minting_burning() {
    ...
    Accounts::set_balance(
        ...
        &token::BaseUnits::new(
            10,
            token::Denomination::from_str(TestErcToken::SYMBOL).unwrap(),
        ),
    );
    Accounts::set_balance(
