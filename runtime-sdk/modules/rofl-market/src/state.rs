...
mod test {
    ...
    fn test_instance_command() {
        ...
        assert_eq!(cmds[0].cmd, cbor::Value::Unsigned(42));
        assert_eq!(cmds[1].id, 2.into());
        assert_eq!(cmds[1].cmd, cbor::Value::Unsigned(43));
        assert_eq!(cmds[2].id, 3.into());
        assert_eq!(cmds[2].cmd, cbor::Value::Unsigned(44));
        ...
        assert_eq!(cmds[0].cmd, cbor::Value::Unsigned(43));
        assert_eq!(cmds[1].id, 3.into());
        assert_eq!(cmds[1].cmd, cbor::Value::Unsigned(44));
    }
}
