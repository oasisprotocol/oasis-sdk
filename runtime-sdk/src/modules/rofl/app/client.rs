    ...
    A: App,
{
    ...
    async fn multi_sign_and_submit_tx(
        ...
        // Ensure consensus verifier is up to date.
        // TODO: Fix handling of HEIGHT_LATEST in Verified::sync then use it here.
        let _ = client
            .state
            .consensus_verifier
            .sync(client.state.consensus_verifier.latest_height().await? + 1)
            .await;
