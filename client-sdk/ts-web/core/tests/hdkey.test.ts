...
describe('HdKey', () => {
    describe('#fromMnemonic', () => {
        it('Should generate the root key from a mnemonic', async () => {
            ...
            expect(toHex(key.public())).toEqual(
                'feb4ffe1b96066dd3c25ce1c468ee70e680c6f94d87dc3f158a2c310cbf37b74',
            );
        });

        it('Should return null on unsecure mnemonics', async () => {
            // Unsecure genre when ahead
            const key = await HDKey.fromMnemonic('genre when ahead');
            expect(key).toBeNull();
        });
    });
    ...
    describe('#fromSeed', () => {
        ...
        it('Should return null on invalid last byte', () => {
            ...
            expect(HDKey.fromSeed(k)).toBeNull();
        });
    });
    ...
    describe('#derivePath', () => {
        ...
        it('Should derive a valid seed', () => {
            ...
            expect(toHex(node.kL)).toEqual(
                '9071c4c83d9ce4736511cf2ab984c157b3a63c30abf638f5e67f485d7dfb9b5e',
            );
        });
        ...
        it('Should derive using hardened offsets', () => {
            ...
            expect(toHex(node.kL)).toEqual(
                'd03f4b1d4482e2192a0fdfbafb716a2e036e013f1e20d41bc62030a582fb9b5e',
            );
        });
    ...
    describe('#sign', () => {
        it('Should produce a valid signature', async () => {
            ...
            expect(toHex(node.A)).toEqual(
                'bb851a8d18ceb11cf26d8e2a49c00ca6a31c3645e4aa6998ea286e7175eda27a',
            );
