...
const methodDescriptorStakingTotalSupply = createMethodDescriptorSimple<bigint, bigint>('Staking', 'TotalSupply');
const methodDescriptorStakingCommonPool = createMethodDescriptorSimple<bigint, bigint>('Staking', 'CommonPool');
const methodDescriptorStakingLastBlockFees = createMethodDescriptorSimple<bigint, bigint>('Staking', 'LastBlockFees');
const methodDescriptorStakingThreshold = createMethodDescriptorSimple<types.NotModeled, bigint>('Staking', 'Threshold');
...
const methodDescriptorStakingDelegations = createMethodDescriptorSimple<types.NotModeled, {[index: string]: types.NotModeled}>('Staking', 'Delegations');
const methodDescriptorStakingDebondingDelegations = createMethodDescriptorSimple<types.NotModeled, {[index: string]: types.NotModeled[]}>('Staking', 'DebondingDelegations');
...
export class OasisNodeClient {
    ...
    private callSimple<REQ, RESP>(desc: grpcWeb.MethodDescriptor<REQ, RESP>, request: REQ): Promise<RESP> {
        return this.client.thenableCall(this.base + desc.name, request, null, desc);
    }
