...
export const ERR_CALL_DEPTH_EXCEEDED_CODE = 16; // No longer emitted
...
export const ERR_ABORT_CODE = 20;
export const ERR_STORAGE_KEY_TOO_LARGE_CODE = 21;
export const ERR_STORAGE_VALUE_TOO_LARGE_CODE = 22;
export const ERR_CRYPTO_MSG_TOO_LARGE_CODE = 23;
export const ERR_CRYPTO_MALFORMED_PUBLIC_KEY_CODE = 24;
export const ERR_CODE_DECLARES_MULTIPLE_SUB_VERSIONS_CODE = 25;
export const ERR_CRYPTO_MALFORMED_PRIVATE_KEY_CODE = 26;
export const ERR_CRYPTO_MALFORMED_KEY_CODE = 27;
export const ERR_CRYPTO_MALFORMED_NONCE_CODE = 28;
export const ERR_CRYPTO_KEY_DERIVATION_FUNCTION_FAILURE_CODE = 29;
export const ERR_MODULE_USES_FLOATING_POINT_CODE = 30;
export const ERR_CODE_DECLARES_TOO_MANY_FUNCTIONS_CODE = 31;
export const ERR_CODE_DECLARES_TOO_MANY_LOCALS_CODE = 32;
